...
class Product_model extends CI_Model {
    ...
    {
        $query = "INSERT INTO `product_tbl` (`id`, `tittle`, `description`, `image`, `date`) VALUES (?,?,?,?,?)";
        $datar = array(NULL, $data['title'], $data['description'], $data['image'], $data['date']);
        $this->db->query($query, $datar);
    }
